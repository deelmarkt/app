      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              _buildHeader('P-05 DeelButton — Component Showcase'),
              ...
              // ── Variants Section ──
              _buildSectionTitle('Variants (Medium size)'),
              ...
              // ── Sizes Section ──
              _buildSectionTitle('Sizes (Primary variant)'),
              const SizedBox(height: 16),
              Wrap(
                spacing: 12,
                runSpacing: 12,
              ...
              // ── States Section ──
              _buildSectionTitle('States (Primary variant)'),
              const SizedBox(height: 16),
              Wrap(
                spacing: 12,
                runSpacing: 12,
              ...
              _buildSectionTitle('All Variants — Disabled'),
              const SizedBox(height: 16),
              Wrap(
                spacing: 12,
                runSpacing: 12,
              ...
              _buildSectionTitle('All Variants — Loading'),
              const SizedBox(height: 16),
              Wrap(
                spacing: 12,
                runSpacing: 12,
